...
class ImageExtension():
    ...
    def load_scheduler(self):
        ...
        self.ddim = DDIMScheduler.from_pretrained(self.base_model_name,
                                                  subfolder="scheduler",
    ...
    def getLatent_model(self):
        # MN = self.base_model_name
        self.vae = AutoencoderKL.from_pretrained(self.base_model_name,
                                                 local_files_only=self.only_local_files,
                                                 torch_dtype=torch.float16,
                                                 #  use_safetensors=True,
                                                 subfolder="vae",
    ...
    def load_text_encoder(self):
        # MN = self.base_model_name
        self.text_encoder = CLIPTextModel.from_pretrained(self.base_model_name,
                                                          local_files_only=self.only_local_files,
                                                          torch_dtype=torch.float16,
                                                          #   use_safetensors=True,
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained(self.base_model_name,
                                                       local_files_only=self.only_local_files,
                                                       subfolder="tokenizer",
                                                       cache_dir=self.cache_dir)
